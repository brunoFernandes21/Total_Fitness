...
const Navbar = () => {
  return (
    ...
    <header className="sticky top-0 z-30 shadow-xl">
      <nav className="nav flex justify-between items-center m-auto py-3 px-5 md:py-5 lg:py-6">
        <Link to={"/"}>
          <h1 className="font-bold text-xl md:text-2xl lg:text-4xl text-slate-100 transition duration-150 ease-in hover:text-slate-300">TOTAL_FITNESS</h1>
        </Link>
